...
def get_training_json(train_info: dict) -> dict:
    ...
    # Do not add --padding_free True: DPO concatenated_forward expects 2*num_examples position_id resets;
    # padding_free packs into 2 sequences and causes IndexError in TRL.
